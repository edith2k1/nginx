...
> Copy this to the file
    ...
    server {
        ...
        location / {
                ...
                proxy_pass http://192.168.217.139:8080;  #change to your internal server IP
                proxy_redirect off;
        }
    }
    
> `http://192.168.217.140:81` ===> `http://192.168.217.139:8080`
...
![image](https://user-images.githubusercontent.com/100410064/167291030-03bb3cd5-2dbe-4061-aeb1-7500cc3e1799.png)
